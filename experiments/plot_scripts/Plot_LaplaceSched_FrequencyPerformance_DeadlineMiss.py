...
def plot_mean_frequency_error_ratio(show_plot, in_csv_file_list, out_plot_file_list, label_list):
    ...
    ax_top.text(0, 1.1, "The Number of Task Sets that Have\nDeadline Misses in {}".format(label_list[-1]),
    ...
    plt.legend(bbox_to_anchor=(0.5,1.4), loc="upper center", shadow=True, edgecolor='k', ncol=2)

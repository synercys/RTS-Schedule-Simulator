...
def plot_mean_frequency_error_ratio(show_plot, in_csv_file_list, out_plot_file_list, label_list):
    ...
    for in_csv_idx in range(len(in_csv_file_list)):
        ...
        this_y = data_dict['Worst_Task_Under_Performance_Ratio']
    ...
    plt.ylabel('Mean of the Worst\nUnder Performance Ratio')

    plt.legend(loc='lower center', shadow=True, edgecolor='k', ncol=2)
...
def get_utilization_mean_precision_list(in_csv_file):
    ...
    precision_list = data_dict['Worst_Task_Under_Performance_Ratio']
